...
![](img/snip of Course Survey Yuyang Sun.png)
...
g = ggplot(iris, 
            aes(x = Petal.Width, 
                y = Petal.Length)) + 
  geom_point() + 
  ggtitle("Yuyang Sun's animation")
g
...
![](img/snip of test animation Yuyang Sun.png)
...
![](img/snip of GitHub Desktop Yuyang Sun.png)
